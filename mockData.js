...
// تدعم مكاتب الأدوية، مخزون الأدوية والمواد الفعالة، المربين ذوي المزارع المتعددة والتحصينات المحددة.
...
const MOCK_DATA = [
  {
    ...
    phone: "01012345678",
    address: "ميت غمر، الدقهلية",
    preferredPharmacyId: "pharmacy_2", // صيدلية الدلتا البيطرية
    financialStatus: {
      hasDebt: true,
      debtAmount: 2500,
    ...
    visits: [
      {
        ...
        prescriptions: [
          { name: "تايلوكير (Tylocare)", activeIngredient: "تايلوزين تارتارات (Tylosin)", dose: "0.5 جرام / لتر", duration: "12 ساعة يومياً لمدة 5 أيام" },
          { name: "فيتامين ك3 مائي", activeIngredient: "فيتامين ك3 (Vitamin K3)", dose: "0.5 جرام / لتر", duration: "مستمر 4 أيام" }
        ],
        labTests: {
          pcr: true,
  ...
  },
  {
    ...
    phone: "01555554433",
    address: "الزقازيق، الشرقية",
    preferredPharmacyId: "pharmacy_1", // مكتب الشرقية البيطري
    financialStatus: {
      hasDebt: false,
      debtAmount: 0,
    ...
    visits: [
      {
        ...
        prescriptions: [
          { name: "بان فلور (Panflor)", activeIngredient: "فلورفينيكول (Florfenicol)", dose: "1 مل / لتر مياه شرب", duration: "12 ساعة يومياً لمدة 4 أيام" },
          { name: "دوكسي سيكلين 20%", activeIngredient: "دوكسي سيكلين (Doxycycline)", dose: "1 جرام / 2 لتر", duration: "12 ساعة يومياً بالتناوب لمدة 4 أيام" }
        ],
        labTests: {
          pcr: true,
...
// تصنيف الأدوية الشائع للاستعانة به للبحث والمطابقة
const MEDICINE_CATALOG = {
  "بان فلور (Panflor)": { category: "Antibiotic", withdrawalDays: 14, doseDefault: "1 مل / لتر", activeIngredient: "فلورفينيكول (Florfenicol)" },
  "أمبروليوم 20%": { category: "Anticoccidial", withdrawalDays: 3, doseDefault: "1 جرام / لتر", activeIngredient: "أمبروليوم (Amprolium)" },
  "تايلوكير (Tylocare)": { category: "Macrolide", withdrawalDays: 5, doseDefault: "0.5 جرام / لتر", activeIngredient: "تايلوزين تارتارات (Tylosin)" },
  "دوكسي سيكلين 20%": { category: "Tetracycline", withdrawalDays: 7, doseDefault: "1 جرام / 2 لتر", activeIngredient: "دوكسي سيكلين (Doxycycline)" },
  "كولستين بلس": { category: "Antibiotic", withdrawalDays: 8, doseDefault: "1 جرام / 2 لتر", activeIngredient: "كولستين كبريتات (Colistin)" },
  "فيتامين ك3 مائي": { category: "Vitamin", withdrawalDays: 0, doseDefault: "0.5 جرام / لتر", activeIngredient: "فيتامين ك3 (Vitamin K3)" },
  "فيتامين أد3هـ مستورد": { category: "Vitamin", withdrawalDays: 0, doseDefault: "1 مل / لتر", activeIngredient: "فيتامين أد3هـ (Vitamin AD3E)" },
  "نيومايسين بيطري": { category: "Antibiotic", withdrawalDays: 5, doseDefault: "1 جرام / لتر", activeIngredient: "نيومايسين كبريتات (Neomycin)" }
};
...
const PRESCRIPTION_TEMPLATES = {
  ...
  "coccidiosis": {
    ...
    prescriptions: [
      { name: "أمبروليوم 20%", activeIngredient: "أمبروليوم (Amprolium)", dose: "1 جرام / لتر", duration: "12 ساعة لمدة 5 أيام" },
      { name: "فيتامين ك3 مائي", activeIngredient: "فيتامين ك3 (Vitamin K3)", dose: "0.5 جرام / لتر", duration: "12 ساعة بالتناوب 4 أيام" }
    ],
...
window.MEDICINE_CATALOG = MEDICINE_CATALOG;
